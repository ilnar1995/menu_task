...
SECRET_KEY = 'django-insecure-m^*=gxozi^fc6-8!mraucu2=t0@z=v+w1-c%-y^ex09m=z23)='
...
]     #                                          #список допольнительных нестандартных путей к стат файлам, используемой для сбора и для режима отладки
